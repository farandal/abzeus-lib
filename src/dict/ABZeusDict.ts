...
const ABZeusDict = ():Dict => {
  ...
  dictionary.c("d", "en", " thought");
  dictionary.c("e", "en", " representation");
  ...
  dictionary.c("i", "en", " description");
  dictionary.c("j", "en", " link");
  dictionary.c("k", "en", " the divergence of information");
  dictionary.c("l", "en", " direction");
  dictionary.c("m", "en", " the plurality");
  dictionary.c("n", "en", " singular model or set");
  dictionary.c("o", "en", " definition");
  dictionary.c("p", "en", " projection");
  dictionary.c("q", "en", " the previous");
  dictionary.c("r", "en", " extension or radius");
